...
namespace ELearning.DAL.Migrations
{
    ...
    [Migration("20220505112949_fourteen")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELearning.DAL.Models.Articles", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ELearning.DAL.Models.Calender", b =>
                {
                    b.HasOne("ELearning.DAL.Models.UserInformation", "User")
            ...
            modelBuilder.Entity("ELearning.DAL.Models.Upload", b =>
                {
                    b.HasOne("ELearning.DAL.Models.Documentation", "Documents")
                        .WithMany("Uploads")
                        .HasForeignKey("DocumentsID");

                    b.HasOne("ELearning.DAL.Models.Project", "Projects")
                        .WithMany("Uploads")
