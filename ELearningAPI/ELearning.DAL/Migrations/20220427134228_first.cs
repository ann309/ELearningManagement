        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentationFile = table.Column<string>(type: "varchar(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectFile = table.Column<string>(type: "varchar(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assign_AssignedBy",
                table: "Assign",
                column: "AssignedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Assign_AssignedTo",
                table: "Assign",
                column: "AssignedTo");

            migrationBuilder.CreateIndex(
                name: "IX_Assign_DocumentationId",
                table: "Assign",
                column: "DocumentationId");

            migrationBuilder.CreateIndex(
                name: "IX_Assign_ProjectId",
                table: "Assign",
                column: "ProjectId");
